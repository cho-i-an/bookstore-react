...
function Cart() {
    ...
    const continueShopping = localStorage.getItem('lastCategoryUrl') || "/categories/Adventure";
    ...
    if (totalQuantity === 0) {
        return (
            <div className="cart-page">
                ...
                <Link to={"/categories/" + (localStorage.getItem('lastCategory') || "")}
                      className="continue-btn-empty-page">
                    Continue Shopping
                </Link>
            </div>
        )
        ...
        return (
            <div className="cart-page">
                ...
                <div className="cart-action-btns">
                    <Link to={"/categories/" + (localStorage.getItem('lastCategory') || "")} className="continue-btn">
                        Continue Shopping
                    </Link>
